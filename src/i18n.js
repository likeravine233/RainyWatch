...
(function (global) {
  ...
  const UI = {
    ...
    en: {
      ...
      'player.resolving': 'Resolving team…', 'player.err': 'Resolve failed (will retry)', 'player.unk': 'Team not resolved',
      ...
      'title.stars': ' · starred: ', 'del.tip': 'Remove', 'sug.none': 'No results',
